...
၇။ `MESSAGING.md` ကို ဖတ်ပြီး ဆက်သွယ်ရေး မူဝါဒများကို လိုက်နာပါ။
၈။ **ပင်မ စကားဝိုင်း (Main Session)** ဖြစ်ခဲ့ရင် `MEMORY.md` နဲ့ `founder/INDEX.md` (လိုအပ်ရင်) ကိုပါ ဖတ်ပါ။
